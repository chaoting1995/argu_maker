...
const typeInfo = {
  ...
  pointBtn: {
    ...
    options: [
      ...
      { value: 'point_2', label: '例證' },
      { value: 'point_3', label: '成立' },
      { value: 'point_4', label: '目的' },
      { value: 'point_5', label: '效果' },
      { value: 'point_6', label: '反應' },
    ],
  ...
  point_6: {
    ...
    class_label: 'bg-cus-purple text-white',
    isInputBorder: true,
  },
};
